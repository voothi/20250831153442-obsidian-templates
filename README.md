...
A **ZID-based methodology** expressed through a curated collection of Obsidian templates and scripts. It implements a "Flat Base" architecture that decouples **logical** hierarchy from the **physical** filesystem, enabling many-to-many knowledge structures and seamless AI collaboration.
